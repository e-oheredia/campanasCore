...
INSERT [dbo].[seguimiento_campana] ([seguimiento_campana_id], [fecha], [observacion], [usuario_id], [campana_id], [estado_campana_id], [matricula]) VALUES (4, CAST(N'2018-12-12T10:53:27.2770000' AS DateTime2), N'', 1, 4, 1, 'OHEREDIA')
INSERT [dbo].[seguimiento_campana] ([seguimiento_campana_id], [fecha], [observacion], [usuario_id], [campana_id], [estado_campana_id], [matricula]) VALUES (5, CAST(N'2018-12-12T10:56:32.0570000' AS DateTime2), N'', 1, 5, 1, 'OHEREDIA')
INSERT [dbo].[seguimiento_campana] ([seguimiento_campana_id], [fecha], [observacion], [usuario_id], [campana_id], [estado_campana_id], [matricula]) VALUES (6, CAST(N'2018-12-12T10:57:19.5450000' AS DateTime2), N'Proveedor: URBANO. Costo: 540.0', 1, 1, 2, 'OHEREDIA')
INSERT [dbo].[seguimiento_campana] ([seguimiento_campana_id], [fecha], [observacion], [usuario_id], [campana_id], [estado_campana_id], [matricula]) VALUES (7, CAST(N'2018-12-12T11:57:19.5450000' AS DateTime2), N'Proveedor: URBANO. Costo: 600.0', 1, 4, 2, 'OHEREDIA')
